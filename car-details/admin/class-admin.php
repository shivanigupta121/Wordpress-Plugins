...
function register_car_post_type() {
    ...
    add_submenu_page(
        ...
        'display_car_settings_page' // Callback function for the settings page
    );
...
function display_car_settings_page() {
    if (isset($_POST['submit_car_settings'])) {
        ...
        if (isset($_POST['car_settings_nonce']) && wp_verify_nonce($_POST['car_settings_nonce'], 'car_settings_nonce')) {
            ...
            update_option('custom_car_form', sanitize_text_field($_POST['custom_car_form']));
            ...
            update_option('custom_car_listing', sanitize_text_field($_POST['custom_car_listing']));
